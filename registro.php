	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form role="form" name="login" action="php/registro.php" method="post" class="login100-form validate-form">
					<span class="login100-form-title">
					 Registro
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Nombre de usuario requerido, ej: Milanesa123">
          ...
          <div class="wrap-input100 validate-input" data-validate = "Nombre requerido">
					...
					<div class="wrap-input100 validate-input" data-validate = "Confirmación de contraseña requerida">
						<input class="input100" type="password" name="confirm_password" placeholder="Verificar Contraseña">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
